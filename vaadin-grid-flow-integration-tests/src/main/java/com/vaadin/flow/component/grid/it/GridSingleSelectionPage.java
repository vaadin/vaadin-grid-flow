...
public class GridSingleSelectionPage extends VerticalLayout {
    ...
    public GridSingleSelectionPage() {
        ...
        NativeButton firstToggle = buildToggle("1st toggle",
                deselectAllowedGrid, DESELECT_ALLOWED_TOGGLE_ID);

        Grid<String> deselectDisallowedGrid = buildGrid(false,
                DESELECT_DISALLOWED_GRID_ID);
        NativeButton secondToggle = buildToggle("2nd toggle",
                deselectDisallowedGrid, DESELECT_DISALLOWED_TOGGLE_ID);
    ...
    private NativeButton buildToggle(String caption, Grid grid, String id) {
