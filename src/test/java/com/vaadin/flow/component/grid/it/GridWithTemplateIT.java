...
public class GridWithTemplateIT extends AbstractComponentIT {
    ...
    public void injectedGrid_cellWithTemplates_buttonIsClicked_cellIsUpdated() {
        TestBenchElement gridInATemplate = $(TestBenchElement.class).id("injected-template-in-cells");
        TestBenchElement grid = gridInATemplate.$("*").id("injected-template-in-cells");
    ...
    public void standaloneGrid_cellWithTemplates_buttonIsClicked_cellIsUpdated() {
        GridElement grid = $(GridElement.class).id("standalone-template-in-cells");
    ...
    public void injectedGrid_headerWithTemplates_buttonIsClicked_headerIsUpdated() {
        TestBenchElement gridInATemplate = $(TestBenchElement.class).id("injected-template-in-header");
        TestBenchElement grid = gridInATemplate.$("*").id("injected-template-in-header");
        scrollToElement(gridInATemplate);
    ...
    public void standaloneGrid_headerWithTemplates_buttonIsClicked_headerIsUpdated() {
        GridElement grid = $(GridElement.class).id("standalone-template-in-header");
        scrollToElement(grid);
    ...
    public void injectedGrid_detailsWithTemplates_buttonIsClicked_detailIsUpdated() {
        TestBenchElement gridInATemplate = $(TestBenchElement.class).id("injected-template-in-details");
        GridElement grid = gridInATemplate.$(GridElement.class).id("injected-template-in-details");
        scrollToElement(gridInATemplate);
    ...
    public void standaloneGrid_detailsWithTemplates_buttonIsClicked_detailIsUpdated() {
        GridElement grid = $(GridElement.class).id("standalone-template-in-details");
        scrollToElement(grid);
    ...
    public void injectedGrid_columnsWithProperties() {
        TestBenchElement gridInATemplate = $(TestBenchElement.class).id("injected-columns-with-properties");
        WebElement grid = gridInATemplate.$("*").id("injected-columns-with-properties");
    ...
    private TestBenchElement findTestTemplateElement(TestBenchElement grid, String id) {
        TestBenchElement idElement = grid.$("*").id(id);
